...
class AppPages {
  ...
  static final routes = [
    ...
    // Follow requests & Feedback routes
    GetPage(
    ...
    GetPage(
      name: AppRoutes.BUY_COINS,
      page: () => const BuyCoinsView(),
      binding: WalletBinding(),
    ),
    GetPage(
    ...
    GetPage(
      name: AppRoutes.GO_LIVE,
      page: () => const GoLiveView(),
    ),
    GetPage(
      name: AppRoutes.WATCH_STREAM,
      page: () => const WatchStreamView(),
    ),
    GetPage(
      name: AppRoutes.USER_PERFORMANCE,
      page: () => const UserPerformanceView(),
