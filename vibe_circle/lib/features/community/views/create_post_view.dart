...
class _CreatePostViewState extends State<CreatePostView> {
  ...
  void _publish() async {
    ...
    if (text.length < 3) {
      Get.snackbar(
        'Input Error',
        'Post content must be at least 3 characters.',
      );
      return;
    }
    ...
    try {
      ...
      if (_postType == 'Image' && _imageFile != null) {
        ...
        final response = await NetworkApiService.instance.uploadFile(
          ApiUrls.uploads,
          file,
        );
  ...
  Widget build(BuildContext context) {
    ...
    final community = _communityId != null
        ? _communityController.communities.firstWhereOrNull(
            (c) => c.id == _communityId,
          )
        : null;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${_bodyController.text.length}/1200',
                        style: const TextStyle(
                          color: AppColors.muted,
                          fontSize: 11.0,
                        ),
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 2.0),
                        Text(
                          'Your identity remains private to other members.',
                          style: TextStyle(
                            color: AppColors.muted,
                            fontSize: 11.0,
                          ),
            ...
            if (_visibility == 'private') ...[
              AppCard(
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Set unlock price (Tiered Pricing) 🪙',
                      style: TextStyle(
                        color: AppColors.primary,
                        fontWeight: FontWeight.bold,
                        fontSize: 14.0,
                    ...
                    const SizedBox(height: 4.0),
                    const Text(
                      'Set the price in coins users must pay to unlock. Allowed range: 5 to 500 coins.',
                      style: TextStyle(color: AppColors.muted, fontSize: 11.0),
                    ),
                    const SizedBox(height: 8.0),
                    AppField(
