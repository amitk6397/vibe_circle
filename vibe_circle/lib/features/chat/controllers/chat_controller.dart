...
class ChatController extends GetxController {
  ...
  Future<Map<String, dynamic>> unlockConversation(String chatId) async {
    return await _chatRepo.unlockConversation(chatId);
  }

  Future<Map<String, dynamic>> deductChatMinute(String chatId) async {
    return await _chatRepo.deductChatMinute(chatId);
  }
